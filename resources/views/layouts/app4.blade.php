...
<head>
    ...
    <meta name="description" content="{{@$seo->description}} - {{@$seo->site_name}}" />
    <meta property="og:type" content="article" />
    <meta property="og:url" content="{{@url()->full()}}" />
    <meta property="og:site_name" content="{{@$seo->site_name}}" />
    <meta property="og:keyword" content="{{str_replace('MaxPreps', $seo->site_name, $data['title'])}} - {{@$seo->site_name}}" />
    <meta property="og:title" content="Watch Streaming - {{str_replace('MaxPreps', $seo->site_name, $data['title'])}}" />
    <meta property="og:description" content="{{@$data['contestdescription']}}" />
